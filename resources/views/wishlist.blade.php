...
<div class="cart-section container">
    <div>
        ...
        <h2>{{ Cart::instance('wishlist')->count() }} produit(s) aimé</h2>
            ...
            <div class="cart-table-row">
                ...
                <div class="cart-table-row-right wishlist-table-row-right">
                    ...
                    <div class="cart-table-actions">
                        ...
                        <form class="heart-item-form" action="{{ route('wishlist.destroy', $item->rowId) }}"
                            method="post">
                            @csrf
                            @method('DELETE')
                        ...
                        <form class="move-to-cart-form" action="{{ route('cart.store') }}" method="post">
                            ...
                            <button class="button button-blue" type="submit">Ajouter au panier</button>
                        </form>
                    </div>
                </div>
        ...
        @else
        <div class="empty">il n'ya aucun produit aimé</div>
        <div class="spacer"></div>
        <a href="{{ route('shop.index') }}" class="button button-white">Continue votre achat</a>
        <div class="spacer"></div>
        @endif
    </div>
