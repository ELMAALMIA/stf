...
<ul class="nav-left">
    ...
    <li class="nav-item-dropdown" data-dropdown-menu="categories-dropdown-menu">
        <a class="custom-dropdown-toggle" data-dropdown-menu="categories-dropdown-menu"
        ...
        <div class="custom-dropdown-menu custom-dropdown-menu-categories">
            <ul class="custom-dropdown-menu-ul" id="categories-dropdown-menu">
                ...
                <li>
                    <a href="{{ route('shop.index', ['category' => lcfirst($category->name)]) }}">{{ $category->name
                        }}</a>
                </li>
                @endforeach
            </ul>
...
<ul class="nav-right">
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('register') }}">{{ __('S\'indentifier') }}</a>
    </li>
    @endif
    @else
    <li class="nav-item-dropdown" data-dropdown-menu="user-dropdown-menu">
        <a class="nav-link custom-dropdown-toggle" data-dropdown-menu="user-dropdown-menu"
            href="{{ route('profile.edit') }}" role="button" data-toggle="dropdown" aria-haspopup="true"
