...
<div class="breadcrumbs">
    <div class="container">
        <div>
            <a href="{{ route('home') }}">Page Pricipale</a>
            ...
            @else
            <span class="visited">Boutique</span>
            @endif
        </div>
    ...
    <div class="sidebar">
        <div class="inner-sidebar">
            ...
            <ul class="categories-list">
                ...
                @else
                <li>
                    <a href="{{ route('shop.index', ['category' => $category->slug, 'sort' => request()->sort]) }}">{{
                        $category->name }}</a>
                </li>
                @endif
                @endforeach
            ...
            <ul class="sort-by-price-list">
                <li class="{{ request()->sort == 'high_low' ? 'active' : ''}}">
                    ...
                    @else
                    <a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'high_low']) }}">Du +
                        cher au - cher </a>
                    @endif
                </li>
                <li class="{{ request()->sort == 'low_high' ? 'active' : ''}}">
                    ...
                    <span>Du - cher au + cher </span>
                    @else
                    <a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'low_high']) }}">Du -
                        cher au + cher</a>
                    @endif
                </li>
