      ...
      <form action="{{ route('checkout.store') }}" method="POST" id="checkout-form">
        ...
        <div class="half-form">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="cc_first_name" name="cc_first_name"
              value="{{ old('cc_first_name') }}" required="">
          </div>
          <div class="form-group">
            <label for="cc_last_name">Last Name on Card</label>
            <input type="text" class="form-control" id="cc_last_name" name="cc_last_name"
              value="{{ old('cc_last_name') }}" required="">
          </div>
        </div> <!-- end half-form -->

        <div class="form-group">
          <label for="cc_phone_number">Card Phone Number</label>
          <input type="text" class="form-control" id="cc_phone_number" name="cc_phone_number"
            value="{{ old('cc_phone_number') }}" required="">
        </div>

        <div class="spacer"></div>

        <div>
          <button type="submit" class="button button-blue  checkout-with-credit-card-button"
            id="checkout-submit-btn">Checkout with Credit Card</button>
        </div>
...
<script src="https://www.paypal.com/sdk/js?client-id={{ config('services.paypal.client_id') }}&disable-funding=card"
