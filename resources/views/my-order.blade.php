...
<div class="breadcrumbs">
    <div class="container">
        <div>
            ...
            <i class="fa fa-chevron-right breadcrumb-separator"></i>
            <span class="visited">Commandes Details</span>
        </div>
...
<div class="products-section container profile-section">
    ...
    <div class="products-section-all">
        <h1 class="stylish-heading"> Details des Commandes</h1>
        ...
        <div class="order-box">
            ...
            <div>
                ...
                <div class="payment-method">
                    ...
                    <img src="/images/mastercard.png" alt="Master Card"> <span>****{{ $order->card_last_four_digits
                        }}</span>
        ...
        {{-- <div class="products-box">
            ...
            <div class="order-products">
                ...
                <div class="product-details">
                    ...
                    <div>
                        <div><a class="product-name" href="{{ route('shop.show', $product) }}">{{ $product->name }}</a>
                        </div>
